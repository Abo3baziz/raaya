...
export function PlanCard({
  ...
  return (
    <article className="flex flex-col justify-between bg-white rounded-3xl w-fit pt-10 px-10 pb-8 min-w-96 h-150 shadow-lg hover:shadow-2xl transition-shadow duration-300">
